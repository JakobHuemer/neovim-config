...
if vue_ls_path ~= "" then
    ...
    local paths = {
        store_dir .. "/lib/language-tools/packages/typescript-plugin",
        store_dir .. "/lib/node_modules/@vue/language-server/node_modules/@vue/typescript-plugin",
        store_dir .. "/lib/node_modules/@vue/typescript-plugin",
    }
